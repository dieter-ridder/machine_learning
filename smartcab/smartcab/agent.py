...
#            self.alpha = self.epsilon
    ...
    def build_state(self):
        ...
        #state is constructed as string:
        #L:<light>_O:<oncoming>_R:<right>_L:<left>__WP:<waypint>
        
        state='L:'+inputs['light']
...
#            state=state+', L:'+'None'
    ...
    def createQ(self, state):
        ...
        if self.learning:
            if state not in self.Q:
                #valid: None, 'forward', 'left', 'right']
                self.Q[state]={None: self.initQ, 'forward': self.initQ, 'right': self.initQ, 'left': self.initQ }
        return
    ...
    def learn(self, state, action, reward):
        ...
        if self.learning:
            print 'learn: before:', self.Q[state][action]
##            self.Q[state][action] += self.alpha * reward
            self.Q[state][action] += self.alpha * (reward-self.Q[state][action])
            print 'learn: after:', self.Q[state][action]
